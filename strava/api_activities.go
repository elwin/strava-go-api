...
*/
func (a *ActivitiesApiService) CreateActivity(ctx context.Context, name string, type_ string, startDateLocal time.Time, elapsedTime int32, description string, distance float32, trainer int32, commute int32, hideFromHome bool) (DetailedActivity, *http.Response, error) {
	var (
	...
	localVarFormParams.Add("hide_from_home", parameterToString(hideFromHome, ""))
